      ...
      content={
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mt-4 text-gray-700 space-y-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              ...
              <div className="space-y-2">
                <p className="font-semibold text-gray-700">Time Complexity:</p>
                <ul className="list-disc pl-6 text-gray-700 space-y-1">
                ...
                <p className="font-semibold text-gray-700 mt-3">Space Complexity:</p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="font-semibold text-gray-700">Space Complexity:</p>
                  <p className="text-gray-700">O(N + M), dominated by DSU arrays (O(N)) and Bloom Filter (O(M) bits)</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-700">Practical Efficiency:</p>
